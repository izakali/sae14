...
class __TwigTemplate_304e36a17b46276e2f74a8b7c9e82039 extends Template
{
    ...
    <section class=\"container mt-4\">
        ...
        <div class=\"mb-3 d-flex align-items-center\">
            ...
            <progress id=\"html\" value=\"80\" max=\"100\" style=\"width: 400px; height: 60px;\">40%</progress>
        </div>

        <div class=\"mb-3 d-flex align-items-center\">
            <label for=\"reseau\" class=\"me-3\">Réseau</label>
            <progress id=\"reseau\" value=\"70\" max=\"100\" style=\"width: 400px; height: 60px;\">80%</progress>
        </div>

        <div class=\"mb-3 d-flex align-items-center\">
            <label for=\"systeme\" class=\"me-3\">Système d'exploitation</label>
            <progress id=\"systeme\" value=\"75\" max=\"100\" style=\"width: 400px; height: 60px;\">95%</progress>
        </div>

        <div class=\"mb-3 d-flex align-items-center\">
            <label for=\"gestion\" class=\"me-3\">Gestion de projet</label>
            <progress id=\"gestion\" value=\"60\" max=\"100\" style=\"width: 400px; height: 60px;\">75%</progress>
        </div>
